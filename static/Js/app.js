...
// Hit Button 
document.querySelector('#blckjack-hit').addEventListener('click',blackjackHit);
// Stand Button 
document.querySelector('#blckjack-stand').addEventListener('click',dealerLogic);
// Dealder Button 
document.querySelector('#blckjack-deal').addEventListener('click',blackjackDeal);
